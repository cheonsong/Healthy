...
extension ProjectDescription.TargetScript {
    public static let localize = TargetScript.pre(script: "python3.10 ../../Scripts/localize.py", name: "Localize", basedOnDependencyAnalysis: false, runForInstallBuildsOnly: true)
